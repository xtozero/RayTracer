...
namespace UnitTest
{
    public static class PlaneTest
    {
        ...
        private static void TestCase01()
        {
            ...
            Tuple n1 = (Tuple)mi.Invoke(p, new object[] { Tuple.Point(0, 0, 0) });
            Tuple n2 = (Tuple)mi.Invoke(p, new object[] { Tuple.Point(10, 0, -10) });
            Tuple n3 = (Tuple)mi.Invoke(p, new object[] { Tuple.Point(-5, 0, 150) });
        ...
        private static void TestCase02()
        {
            ...
            List<Intersection> xs = (List<Intersection>)mi.Invoke(p, new object[] { r });

            Assert.Empty(xs);

            r = new Ray(Tuple.Point(0, 0, 0), Tuple.Vector(0, 0, 1));
            xs = (List<Intersection>)mi.Invoke(p, new object[] { r });
